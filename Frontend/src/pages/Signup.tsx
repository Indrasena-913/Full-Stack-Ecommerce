	...
	const CartoonCharacter = () => {
		return (
			<div className="absolute right-4 top-4 w-16 h-16 transition-all duration-500 ease-in-out">
				...
				{animationFrame === 1 && (
					<div className="relative">
						<div className="w-12 h-12 bg-blue-400 rounded-full flex items-center justify-center animate-pulse">
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 left-3"></div>
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 right-3"></div>
							<div className="w-6 h-1 bg-black rounded-full absolute top-7 transform rotate-180 scale-x-75"></div>
						</div>
						<div className="text-xs mt-1 text-center font-bold text-blue-600">
							Fill in!
						</div>
				...
				{animationFrame === 2 && (
					<div className="relative">
						<div className="w-12 h-12 bg-green-400 rounded-full flex items-center justify-center animate-wiggle">
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 left-3"></div>
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 right-3"></div>
							<div className="w-6 h-2 bg-black rounded-full absolute top-7 transform rotate-0 scale-75"></div>
						</div>
						<div className="text-xs mt-1 text-center font-bold text-blue-600">
							Almost done!
						</div>
	...
	return (
		<div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-100 to-blue-50 relative overflow-hidden">
			...
			>
				...
				<div className="text-3xl font-bold text-white mt-4 animate-bounce">
					Welcome to Flipkart!
				</div>
			</div>
				...
				<form onSubmit={handleSubmit} className="space-y-4 mt-6">
					{step === 1 ? (
						...
						<>
							...
							<div>
								<Label className="text-blue-700 font-medium">Role</Label>
								<div className="relative">
									<select
										name="role"
										value={formData.role}
										onChange={handleChange}
										className="w-full p-2 border-2 border-blue-200 focus:border-blue-500 rounded-md pl-10"
									>
					...
					<div className="flex space-x-2 pt-2">
						{step === 2 && (
							<Button
								type="button"
								variant="outline"
								className="flex-1 border-2 border-blue-300 text-blue-600"
								onClick={prevStep}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
					...
					{step === 1 && (
						<Button
							variant="outline"
							className="w-full border-2 border-blue-500 text-blue-600 hover:bg-blue-50 transition-all duration-300"
