...
const Login: React.FC<LoginProps> = ({ setUser }) => {
	...
	const CartoonCharacter = () => {
		return (
			<div className="absolute right-4 top-4 w-16 h-16 transition-all duration-500 ease-in-out">
				{animationState === 0 && (
				...
				{animationState === 1 && (
					<div className="relative">
						<div className="w-12 h-12 bg-blue-400 rounded-full flex items-center justify-center animate-pulse">
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 left-3"></div>
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 right-3"></div>
							<div className="w-6 h-1 bg-black rounded-full absolute top-7 transform rotate-12 scale-x-75"></div>
						</div>
						<div className="text-xs mt-1 text-center font-bold text-blue-600">
							Welcome!
						</div>
				...
				{animationState === 2 && (
					<div className="relative">
						<div className="w-12 h-12 bg-green-400 rounded-full flex items-center justify-center animate-spin-slow">
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 left-3"></div>
							<div className="w-2 h-2 bg-black rounded-full absolute top-3 right-3"></div>
							<div className="w-6 h-2 bg-black rounded-full absolute top-7"></div>
						</div>
						<div className="text-xs mt-1 text-center font-bold text-blue-600">
							Login now!
						</div>
	...
	return (
		<div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-100 to-blue-50 relative overflow-hidden">
			...
			<div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
				...
				{/* Shopping Cart Icon */}
				<div className="absolute top-10 left-10 text-blue-600 animate-bounce">
					<svg
				...
				{/* Package Icon */}
				<div className="absolute bottom-10 right-10 text-blue-600 animate-pulse">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						className="h-12 w-12"
						viewBox="0 0 24 24"
			...
			<Card className="p-6 w-full max-w-md shadow-xl bg-white relative z-10 border-2 border-blue-500 rounded-lg">
				<div className="flex justify-center mb-6">
					<div className="text-3xl font-bold text-blue-600 tracking-tight flex items-center">
						<span className="text-blue-600">Flip</span>
						<span className="text-yellow-500">kart</span>
						<span className="ml-2 text-base italic font-normal text-gray-500">
							inspired
						</span>
					</div>
				</div>
				...
				<form onSubmit={handleSubmit} className="space-y-4 mt-6">
					<div className="relative">
						...
						<Input
							...
							required
							className="border-2 border-blue-200 focus:border-blue-500 transition-all duration-300 pl-10"
						/>
						<div className="absolute left-3 bottom-2.5 text-blue-500">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="h-5 w-5"
								viewBox="0 0 20 20"
					...
					{error && (
						<div className="bg-red-50 p-2 rounded border border-red-200 flex items-center text-red-500 text-sm animate-pulse">
							<svg
								xmlns="http://www.w3.org/2000/svg"
					...
					<Button
						type="submit"
						className="w-full bg-blue-600 hover:bg-blue-700 text-white text-lg py-2 transition-all duration-300 transform hover:scale-105"
						disabled={loading}
					>
						{loading ? (
					...
					<Button
						variant="outline"
						className="w-full border-2 border-blue-500 text-blue-600 hover:bg-blue-50 font-medium transition-all duration-300"
				...
				<div className="mt-6 flex justify-center space-x-4">
					<div className="p-2 bg-gray-100 rounded-full text-blue-600 transition transform hover:scale-110 cursor-pointer">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
						</svg>
					</div>
					<div className="p-2 bg-gray-100 rounded-full text-red-500 transition transform hover:scale-110 cursor-pointer">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
					...
					<div className="p-2 bg-gray-100 rounded-full text-blue-400 transition transform hover:scale-110 cursor-pointer">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.016 10.016 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
						</svg>
					</div>
					<div className="p-2 bg-gray-100 rounded-full text-green-500 transition transform hover:scale-110 cursor-pointer">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
